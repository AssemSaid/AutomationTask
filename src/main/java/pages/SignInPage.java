...
public class SignInPage extends BasePage {
	...
	public void enterRadomEmail() {
		...
		String generatedEmail = getGeneratedEmail();
		driver.findElement(emailField).sendKeys(generatedEmail);
		
		logs.addLog("Info: Enter the autogenerated email: ("+generatedEmail+") in Email field");
	}

	public CreateAccountPage clickCreateAccount() {
		driver.findElement(createAccountButton).click();
		
		logs.addLog("Info: Click on (Create Account) button");
